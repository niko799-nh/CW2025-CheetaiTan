...
public class GuiController implements Initializable {
    ...
    public void pauseGame(ActionEvent actionEvent) {
        if (isPause.getValue()) {
            ...
            pauseLabel.setLayoutX((gamePanel.getWidth() - -95)/2);
